...
function show_usage() {
    ...
    echo ""
    echo "  gbranches CDC-123-card-feature-name -p -pr -b \"Implements user authentication feature\""
    echo "  Creates branches, pushes to remote, and creates PRs"
    echo ""
    echo "  gbranches CDC-123-card-feature-name -p -pr -b \"Implements user authentication feature\" -pr-body \"Implements user authentication feature\""
